...
.disclosure a { color: #0A0A0A; text-decoration: underline; }
      ...
      <div className="auth-shell">
        ...
        <main className="form-panel">
          ...
          <div className="form-inner">
            <h2 className="form-inner__heading">Start investing in 5 minutes or less.</h2>
            ...
            <div className="form-fields">
              <div className={`input-wrap${phoneActive ? ' active' : ''}`}>
              ...
              <p className="disclosure">
                Your data is securely stored with encryption on US servers, we won't spam you, and we will never sell your personal information. By clicking Continue, you agree to our{' '}
                <a href="#">terms</a> and acknowledge that we process your personal information in accordance with our{' '}
